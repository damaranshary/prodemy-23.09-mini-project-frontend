        ...
        <div className="grid grid-cols-3 gap-4 ">
          {filteredProducts.map((product) => (
            <div key={product.id} className="border p-4 rounded-xl">
              ...
              />
              <h3 className="font-bold mb-2 justify-center text-2xl ">
                {product.name}
              </h3>
        ...
        <div className="flex flex-col justify-center items-center bg-grey-200">
          ...
          <div className="flex flex-row mb-10 ">
            <button
              ...
              className="bg-yellow-400 text-white px-8 py-4 mr-4 ml-4 rounded-md"
            >
              Semua
            </button>
            <button
            ...
            <button
              ...
              className="bg-blue-500 text-white px-8 py-4 mr-4 ml-4 rounded-md"
            >
              Minuman
            </button>
            <button
              ...
              return (
                <li key={product.id} className="border p-4 rounded mb-2">
                  ...
                  <button
                    ...
                    className="bg-red-500 text-white px-4 py-2 ml-5 rounded"
                  >
                    Delete
                  </button>
                </li>
